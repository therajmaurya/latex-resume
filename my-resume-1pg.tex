...
%-----------------------------------------------------------
% {{{
\usepackage[top=0.25in, bottom=0.5in, left=0.5in, right=0.5in]{geometry}
...
\begin{itemize}
    ...
    \begin{itemize}\itemsep \isep
        % \item Responsible for building end-to-end \textbf{Generative AI and NLP} solutions
    ...
    \begin{itemize}\itemsep \isep
        ...
        \item Worked with \textbf{cross-functional teams} for end-to-end model deployments in production
...
\begin{itemize}
  ...
  \item[] $\circ$  \hspace{0.0cm} \textbf{Tools/Libraries}: Numpy, Pandas, Scikit-learn, PyTorch, HuggingFace, LangChain, Streamlit, FastAPI, Flask \\[-0.55cm]
  \item[] $\circ$  \hspace{0.0cm} \textbf{Others}: MLOps, LLMOps, Git, Docker, Kubernetes, AWS, Azure, OpenSearch, Terraform
\end{itemize}
% }}}
...
\\[-0.6cm]
    \begin{itemize}\itemsep \isep
        ...
        \item Integrated and deployed 16+ models including \textbf{VGG16, ResNet, YOLO, SVM,} etc. using CI/CD
    \end{itemize}
