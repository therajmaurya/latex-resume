...
%-----------------------------------------------------------
% {{{
\usepackage[top=0.3in, bottom=0.4in, left=0.5in, right=0.5in]{geometry}
...
%{{{
\begin{itemize}
  \item \textbf{Languages}: Python, SQL\\[-0.5cm]
  \item \textbf{Data Science}: Statistics, Machine Learning, Deep Learning, Natural Language Processing, Computer Vision  \\[-0.55cm]
  \item \textbf{Generative AI}: Foundation Models, Attention \& Transformers, Stable Diffusion, Prompt Engineering, \\Vector Databases, Chunking Strategy, Context Management, Retrieval-augmented Generation (RAG), \\Agentic Framework, Large Language Models' Finetuning, Model Optimization for GPUs \\[-0.55cm]
  \item \textbf{Tools/Libraries}: Numpy, Pandas, Scikit-learn, PyTorch, HuggingFace, LangChain, Flask \\[-0.55cm]
  \item \textbf{Others}: MLOps, LLMOps, Git, Docker, AWS, Azure, Jira
\end{itemize}
% }}}
